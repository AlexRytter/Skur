    ...
    <div className="page-wrap">
      ...
      <div className="booking-list">
        {messages && messages.length > 0 ? (
          messages.map((msg) => (
            <div className="booking-row" key={msg.id} style={{ flexDirection: 'column', alignItems: 'stretch', gap: 8 }}>
              ...
              {msg.reply && (
                <p style={{ margin: 0, color: '#0f6e56' }}>
                  <strong>Dit svar:</strong> {msg.reply}
                </p>
              )}
              <form
                action={async (formData) => {
              ...
              >
                <input name="reply" defaultValue={msg.reply || ''} placeholder="Skriv et svar..." style={{ flex: 1, padding: 8 }} />
                <button type="submit" className="btn-primary" style={{ width: 'auto', padding: '8px 14px' }}>
                  Svar
                </button>
              </form>
